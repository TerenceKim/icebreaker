...
***************************************/
...
#if (CodecI2CM_RX_WAKE_SCL_MOSI_PIN)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define CodecI2CM_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (CodecI2CM_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define CodecI2CM_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) CodecI2CM_INTCFG_TYPE_MASK << \
    ...
    #define CodecI2CM_TX_HSIOM_PTR   ( (reg32 *) CodecI2CM_tx_0__HSIOM)
