...
#define CodecI2CM_I2C_SLAVE_ADDRESS          (8u)
#define CodecI2CM_I2C_SLAVE_ADDRESS_MASK     (254u)
...
#define CodecI2CM_I2C_RX_CTRL    ((CodecI2CM_FIFO_SIZE - 1u)  | \
                                         CodecI2CM_RX_CTRL_MSB_FIRST | \
                                         CodecI2CM_RX_CTRL_ENABLED)

#define CodecI2CM_I2C_TX_CTRL    ((CodecI2CM_FIFO_SIZE - 1u)  | \
...
***************************************/
    ...
    #define CodecI2CM_I2C_DEFAULT_INTR_MASTER_MASK   ((CodecI2CM_I2C_MASTER) ? \
                                                                (CodecI2CM_I2C_INTR_MASTER_MASK) : (0u))
