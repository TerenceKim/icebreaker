...
#define CodecI2CM_EZBUF_DATA00_REG       (*(reg32 *) CodecI2CM_SCB__EZ_DATA00)
#define CodecI2CM_EZBUF_DATA00_PTR       ( (reg32 *) CodecI2CM_SCB__EZ_DATA00)
...
#if (CodecI2CM_CY_SCBIP_V0 || CodecI2CM_CY_SCBIP_V1)
    #define CodecI2CM_FF_DATA_NR_LOG2_PLUS1_MASK (0x0Fu) /* FF_DATA_NR_LOG2_PLUS1 = 4, MASK = 2^4 - 1 = 15 */
    #define CodecI2CM_FF_DATA_NR_LOG2_MASK       (0x07u) /* FF_DATA_NR_LOG2 = 3, MASK = 2^3 - 1 = 7 */
#else
    #define CodecI2CM_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* FF_DATA_NR_LOG2_PLUS1 = 5, MASK = 2^5 - 1 = 31 */
    #define CodecI2CM_FF_DATA_NR_LOG2_MASK       (0x0Fu) /* FF_DATA_NR_LOG2 = 4, MASK = 2^4 - 1 = 15 */
#endif /* (CodecI2CM_CY_SCBIP_V0 || CodecI2CM_CY_SCBIP_V1) */
...
#define CodecI2CM_FIFO_SIZE      (8u)   /* Size of TX or RX FIFO: defined by HW */
#define CodecI2CM_EZBUFFER_SIZE  (32u)  /* EZ Buffer size: defined by HW        */
