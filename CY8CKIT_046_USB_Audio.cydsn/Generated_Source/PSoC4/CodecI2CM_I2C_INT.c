...
CY_ISR(CodecI2CM_I2C_ISR)
{
                ...
                while(CodecI2CM_I2C_FIFO_SIZE != CodecI2CM_GET_TX_FIFO_ENTRIES)
                {
                    ...
                    */
                    ...
                    /* Probably Overflow */
                    {
                        ...
                        if(0u == (CodecI2CM_INTR_TX_OVERFLOW & CodecI2CM_slOverFlowCount))
                        {
    ...
    */
    ...
    {
        CodecI2CM_CTRL_REG &= (uint32) ~CodecI2CM_CTRL_ENABLED; /* Disable scb IP */

        CodecI2CM_state = CodecI2CM_I2C_FSM_IDLE;

        CodecI2CM_DISABLE_SLAVE_AUTO_DATA;
        CodecI2CM_DISABLE_MASTER_AUTO_DATA;
        ...
        CodecI2CM_ClearTxInterruptSource(CodecI2CM_INTR_RX_ALL);
        CodecI2CM_ClearRxInterruptSource(CodecI2CM_INTR_TX_ALL);
        CodecI2CM_ClearSlaveInterruptSource(CodecI2CM_INTR_SLAVE_ALL);
        CodecI2CM_ClearMasterInterruptSource(CodecI2CM_INTR_MASTER_ALL);
    #endif /* (CodecI2CM_CY_SCBIP_V0) */

        CodecI2CM_CTRL_REG |= (uint32) CodecI2CM_CTRL_ENABLED;  /* Enable scb IP */
    }
