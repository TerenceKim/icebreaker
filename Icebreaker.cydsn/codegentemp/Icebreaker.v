...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=63000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=2, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=0, TCCountingModes=2, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=2, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=LED_RED_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LED_RED_PWM, CY_INSTANCE_SHORT_NAME=LED_RED_PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LED_RED_PWM, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=1, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=63000, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=2, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=0, TCCountingModes=2, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=2, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=LED_GREEN_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LED_GREEN_PWM, CY_INSTANCE_SHORT_NAME=LED_GREEN_PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=LED_GREEN_PWM, )
...
module top ;
    ...
    Timer_v2_80_1 Async_Feedback_Counter (
        .reset(Net_4622),
        .interrupt(Net_4623),
        .enable(1'b1),
        .trigger(1'b1),
    ...
    TCPWM_P4_v2_10_2 ByteCounter_Tx (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(TxCount),
    ...
    TCPWM_P4_v2_10_3 ByteCounter_Rx (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(RxCount),
	...
	cy_psoc3_pins_v1_10
		#(.id("2a3273d7-09f0-4fed-8ed7-671d014dd8c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__POTR_net;
	wire [0:0] tmpFB_0__POTR_net;
	wire [0:0] tmpIO_0__POTR_net;
	wire [0:0] tmpINTERRUPT_0__POTR_net;
	electrical [0:0] tmpSIOVREF__POTR_net;
	...
	cy_psoc3_pins_v1_10
		...
		POTR
		 (.oe(tmpOE__POTR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POTR_net[0:0]}),
		  .analog({Net_4777}),
		  .io({tmpIO_0__POTR_net[0:0]}),
		  .siovref(tmpSIOVREF__POTR_net),
		  .interrupt({tmpINTERRUPT_0__POTR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POTR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__POTL_net;
	wire [0:0] tmpFB_0__POTL_net;
	wire [0:0] tmpIO_0__POTL_net;
	wire [0:0] tmpINTERRUPT_0__POTL_net;
	electrical [0:0] tmpSIOVREF__POTL_net;

	cy_psoc3_pins_v1_10
		#(.id("169e56f7-3412-45a5-8336-07b0db29f736"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		POTL
		 (.oe(tmpOE__POTL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POTL_net[0:0]}),
		  .analog({Net_4788}),
		  .io({tmpIO_0__POTL_net[0:0]}),
		  .siovref(tmpSIOVREF__POTL_net),
		  .interrupt({tmpINTERRUPT_0__POTL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POTL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 Resistor_Red_3 (
        .connect({
            Net_4848,
            Net_4847
        })
    );
    defparam Resistor_Red_3.comp_name = "Resistor_v1_0";
    defparam Resistor_Red_3.port_names = "T1, T2";
    defparam Resistor_Red_3.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("6bca6aad-cd74-4e5e-875f-492ebf02cd46"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2edb5659-d3de-443e-b044-e5a1fd114b96"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Resistor_Red_4 (
        .connect({
            Net_4850,
            Net_4849
        })
    );
    defparam Resistor_Red_4.comp_name = "Resistor_v1_0";
    defparam Resistor_Red_4.port_names = "T1, T2";
    defparam Resistor_Red_4.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("0c07d182-4b74-4446-9be0-33172bfd52e5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Resistor_Red_5 (
        .connect({
            Net_4854,
            Net_4851
        })
    );
    defparam Resistor_Red_5.comp_name = "Resistor_v1_0";
    defparam Resistor_Red_5.port_names = "T1, T2";
    defparam Resistor_Red_5.width = 2;
	...
	cy_psoc3_pins_v1_10
		#(.id("aeb26ab7-0dc4-4c65-873b-dd1f1060d551"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Resistor_Red_6 (
        .connect({
            Net_4888,
            Net_4887
        })
    );
    defparam Resistor_Red_6.comp_name = "Resistor_v1_0";
    defparam Resistor_Red_6.port_names = "T1, T2";
    defparam Resistor_Red_6.width = 2;

    cy_annotation_universal_v1_0 VDD_5 (
        .connect({
            Net_4888
        })
    );
    defparam VDD_5.comp_name = "Power_v1_0";
    defparam VDD_5.port_names = "T1";
    defparam VDD_5.width = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("fc5e720a-dbc5-4223-b20f-5e6d1d2cc6ca"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    TCPWM_P4_v2_10_10 LED_GREEN_PWM (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
    ...
    cy_annotation_universal_v1_0 Resistor_Red_7 (
        .connect({
            Net_4946,
            Net_4944
        })
    );
    defparam Resistor_Red_7.comp_name = "Resistor_v1_0";
    defparam Resistor_Red_7.port_names = "T1, T2";
    defparam Resistor_Red_7.width = 2;

    cy_annotation_universal_v1_0 VDD_6 (
        .connect({
            Net_4946
        })
    );
    defparam VDD_6.comp_name = "Power_v1_0";
    defparam VDD_6.port_names = "T1";
    defparam VDD_6.width = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("8440a286-eda4-4774-8d70-0ec0410a83da"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
