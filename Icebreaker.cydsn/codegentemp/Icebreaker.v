...
module top ;
	...
	wire [0:0] tmpOE__RSTn_net;
	wire [0:0] tmpFB_0__RSTn_net;
	wire [0:0] tmpIO_0__RSTn_net;
	wire [0:0] tmpINTERRUPT_0__RSTn_net;
	electrical [0:0] tmpSIOVREF__RSTn_net;
	...
	cy_psoc3_pins_v1_10
		...
		RSTn
		 (.oe(tmpOE__RSTn_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RSTn_net[0:0]}),
		  .io({tmpIO_0__RSTn_net[0:0]}),
		  .siovref(tmpSIOVREF__RSTn_net),
		  .interrupt({tmpINTERRUPT_0__RSTn_net[0:0]}),
		  .annotation({Net_4987}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RSTn_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
