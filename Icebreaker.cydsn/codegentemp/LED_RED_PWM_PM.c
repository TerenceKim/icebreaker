...
static LED_RED_PWM_BACKUP_STRUCT LED_RED_PWM_backup;
...
{
    if(0u != (LED_RED_PWM_BLOCK_CONTROL_REG & LED_RED_PWM_MASK))
    {
        LED_RED_PWM_backup.enableState = 1u;
    }
    else
    {
        LED_RED_PWM_backup.enableState = 0u;
    }
...
void LED_RED_PWM_Wakeup(void)
{
    ...
    if(0u != LED_RED_PWM_backup.enableState)
    {
        LED_RED_PWM_Enable();
    }
}
