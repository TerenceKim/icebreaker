...
static LED_GREEN_PWM_BACKUP_STRUCT LED_GREEN_PWM_backup;
...
{
    if(0u != (LED_GREEN_PWM_BLOCK_CONTROL_REG & LED_GREEN_PWM_MASK))
    {
        LED_GREEN_PWM_backup.enableState = 1u;
    }
    else
    {
        LED_GREEN_PWM_backup.enableState = 0u;
    }
...
void LED_GREEN_PWM_Wakeup(void)
{
    ...
    if(0u != LED_GREEN_PWM_backup.enableState)
    {
