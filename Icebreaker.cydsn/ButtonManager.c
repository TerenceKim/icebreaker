...
static const uint32_t btn_to_ue_lut[NWK_STATE_MAX][BM_DURATION_MAX] =
{
  ...
  {
    0, // BM_DURATION_NONE,
    SYS_EVENTS_UE_POWER_ON, // BM_DURATION_PRESS,
    0, // BM_DURATION_PRESS_RELEASE,
    0, // BM_DURATION_LONG_PRESS,
    0, // BM_DURATION_LONG_PRESS_RELEASE,
    SYS_EVENTS_UE_SWITCH_ROLE, // BM_DURATION_VLONG_PRESS,
  ...
  {
    0, // BM_DURATION_NONE,
    SYS_EVENTS_UE_POWER_OFF, // BM_DURATION_PRESS,
    0, // BM_DURATION_PRESS_RELEASE,
    0, // BM_DURATION_LONG_PRESS,
    0, // BM_DURATION_LONG_PRESS_RELEASE,
  ...
  // NWK_STATE_auto_joining,
  {
    ...
    SYS_EVENTS_UE_POWER_OFF, // BM_DURATION_PRESS,
    0, // BM_DURATION_PRESS_RELEASE,
    SYS_EVENTS_UE_ENTER_PAIRING, // BM_DURATION_LONG_PRESS,
    0, // BM_DURATION_LONG_PRESS_RELEASE,
    0, // BM_DURATION_VLONG_PRESS,
    0, // BM_DURATION_VLONG_PRESS_RELEASE,
    0, // BM_DURATION_VVLONG_PRESS,
